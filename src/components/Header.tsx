        ...
        <div className="flex h-16 items-center justify-between gap-4">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-xl font-bold text-primary-600">TeleList</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/dashboard"
              className="hidden rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:block"
            >
              Dashboard
            </Link>
          </div>
